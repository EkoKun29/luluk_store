...
@endsection
@section('create-link')
    <a href="{{ route('debt-payments.transfer.create') }}" class="btn btn-primary">Tambah</a>
@endsection
@section('table')
    <table class="table table-striped" style="width: 100%;" id="tableDebtPaymentTransfer">
        <thead>
            <tr>
                <th>
                    <h6>Tanggal</h6>
...
<script>
    $(document).ready(function() {
        let table = new DataTable('#tableDebtPaymentTransfer', {
            "columnDefs": [{
                "targets": 4,
                "orderable": false
            }]
